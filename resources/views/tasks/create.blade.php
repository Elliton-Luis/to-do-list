...
@section('content')
    ...
    <div class="max-w-xl mx-auto">
        <h1 class="text-3xl font-semibold text-gray-800 mb-6">Criar Nova Tarefa</h1>
            ...
            <form action="{{ route('tasks.store') }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <textarea name="description" id="description" rows="4"
                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 sm:text-sm">{{ old('description') }}</textarea>
                </div>
